...
class RunManager:
    def __init__(self):       # class constructor
        ...
        self.true_epoch_train_recall = None
    ...
    def track_num_correct(self, train_recall, train_precision, train_f1_score):
    ...
    def track_test_num_correct(self, test_recall, test_precision, test_f1_score):
    ...
    def track_test_epoch_metrics(self, my_tp, my_fp, my_fn):
